  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "KayzCharmzz — a store with a purpose. Handmade jewelry, candles, tumblers, charms, and diamond art kits. Female and Black owned in Cleveland, Ohio.",
      },
