  ...
  return (
    <main className="pb-nav pb-20">
      <PageIntro kicker="The house" title="About KayzCharmzz">
        A handmade boutique for jewelry, candles, tumblers, charms, and diamond
        art kits.
      </PageIntro>
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 md:grid-cols-2">
        ...
        <div className="space-y-5 text-muted">
          ...
          <p>
            KayzCharmzz is part of{" "}
            <a href={FAMILY.parent.href} className="text-gold transition-colors hover:text-gold-soft">
              {FAMILY.parent.name}
            </a>
            . Original diamond painting kits live at{" "}
            <a href={FAMILY.sparkle.href} className="text-gold transition-colors hover:text-gold-soft">
              {FAMILY.sparkle.name}
            </a>
            .
          </p>
